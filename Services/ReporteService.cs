...
public class ReporteService
{
    ...
    public List<PlatoMasPedidoDTO> GetPlatosMasPedidos(DateTime? fechaInicio, DateTime? fechaFin, string? nombreRestaurante)
    {
        var query = _context.ItemAsRestaurantes
            .Include(i => i.Restaurante)
            .Include(i => i.MenuItem)
            .ThenInclude(m => m.MenuCategoria) // Se incluye la categoría
            .AsQueryable();
    ...
    public List<PlatoMasPedidoDTO> GetPlatosMasPedidosAntiguo(DateTime? fechaInicio, DateTime? fechaFin, string? nombreRestaurante)
    {
        var query = _context.ItemAsRestaurantes
            .Include(i => i.Restaurante)
            .Include(i => i.MenuItem)
